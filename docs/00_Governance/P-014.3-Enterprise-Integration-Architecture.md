...
**Architecture Baseline:** v2.0 Multi-Domain Baseline ([P-016.6](./P-016.6-Architecture-Baseline.md) @ `4cc8578`)
...
| **Enterprise-wide integration readiness** | **CONDITIONAL GO** — ADR-014 registry · CRM chain · FIN-R-001 |
...
**Enterprise readiness (v2.0):** Durable transport certified · one production cross-domain chain live · Finance hub pattern established · full multi-domain catalogue and external connector platform deferred to v2.1+.
...
| **CRM** | Accounts · opportunities · pipeline · commercial parties | `crm.opportunity.won` · `crm.revenue.recognized` *(planned)* | Pipeline projections · revenue forecasts | Finance · Intelligence · Marketing |
