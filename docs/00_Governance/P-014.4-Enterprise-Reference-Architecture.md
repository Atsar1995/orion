...
**Architecture Baseline:** v2.0 Multi-Domain Baseline ([P-016.6](./P-016.6-Architecture-Baseline.md) @ `e9f00f0`)
...
| **Platform ready for unconstrained domain build** | **CONDITIONAL GO** — FIN-R-001 · ADR-014 registry · CRM facade |
...
| **CRM** | Next reference target | Facade convergence pending | Must match HCM by Gate 6 |
...
| **CRM** | Account · opportunity · pipeline | `crm.*` *(planned)* | Finance · Intelligence |
