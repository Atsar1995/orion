...
**Architecture Baseline:** v2.0 Multi-Domain Baseline ([P-016.6](./P-016.6-Architecture-Baseline.md) @ `b6d2fb7`)
...
| **Immediate greenfield domain expansion** | **CONDITIONAL GO** — FIN-R-001 · ADR-014 registry · CRM facade |
...
|-----------|----------------------|----------------|-------------|
| **Domains authoritative** | HCM (reference) · Finance (Wave A) | HCM + Finance + CRM | Full operational + industry suite |
| **Integration** | Durable IIL · HCM→Finance certified | Multi-domain event registry | Enterprise-wide contract catalogue |
...
| **Commercial** | Accounts · Opportunities · Pipeline · Revenue events | **CRM / Sales** | ◐ Workspace certified |
...
| **CRM** | `crm` | **Core Domain** | ORION Customer | ◐ Facade convergence pending |
...
| `crm.revenue.recognized` | CRM | Finance | ⏳ Gate 6 |
